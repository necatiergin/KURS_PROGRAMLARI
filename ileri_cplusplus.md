...
+ temporary materialization _(Prvalue Xvalue conversion)_, unmaterialized object passing, geri dönüş değeri optimizasyonu _(return value optimization (RVO))_, isimlendirilmiş geri dönüş değeri optimizasyonu _(named return value optimization (NRVO))_, kopyalama eliminasyonunu engelleyen durumlar, değerle _throw_ etmek, _(throwing by value)_, değerle yakalamak _(catching by value)_ garanti edilmiş kopyalama eliminasyonu _(mandatory copy elision C++17)_
